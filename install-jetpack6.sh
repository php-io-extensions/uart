...
# Installer for the UART extension on NVIDIA JetPack 6 (Jetson).
# Identical workflow to the Debian Trixie script; provided separately
# so JetPack-specific notes and future adaptations remain isolated.
...
header() {
    echo "=========================================="
    echo " UART Extension Installer (JetPack 6)"
    echo "=========================================="
    echo ""
}
