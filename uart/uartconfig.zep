...
class UARTConfig
{
    ...
    public static function setBaudRate(int fd, int baud) -> int
    {
        ...
        let result = uart_set_baud_rate(fd, baud);
    ...
    public static function setDataBits(int fd, int bits) -> int
    {
        ...
        let result = uart_set_data_bits(fd, bits);
    ...
    public static function setStopBits(int fd, int bits) -> int
    {
        ...
        let result = uart_set_stop_bits(fd, bits);
    ...
    public static function setParity(int fd, int parity) -> int
    {
        ...
        let result = uart_set_parity(fd, parity);
    ...
    public static function setFlowControl(int fd, int flow) -> int
    {
        ...
        let result = uart_set_flow_control(fd, flow);
    ...
    public static function getAttributes(int fd) -> array
    {
        ...
        let attrs = uart_get_attributes(fd);
     ...
     * @return int 0 on success, -1 on failure
     */
    public static function setAttributes(int fd, var attrs) -> int
    {
        int result;

        let result = uart_set_attributes(fd, attrs);
